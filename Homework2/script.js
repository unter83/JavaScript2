...
function task21() {
    ...
    const book = new Book('Tom Sawyer', "Mark Twen", 100);
...
function task23() {
    ...
    class Phonebook {
        ...
        showContacts() {
            this.phoneBook.forEach(element => {
                console.log(element);
            });
        ...
        findContactByName(name) {
            ...
            //     }
            // });
            return this.phoneBook.filter(element => element.name === name );
        }

        deleteContact(name) {
            const tempPhoneBook = this.phoneBook.filter(element => element.name !== name );
            this.phoneBook = tempPhoneBook;
        }
    ...
    phonebook.addContact("Иванов", "123-45-67");
    phonebook.addContact("Петров", "987-65-43");
    phonebook.addContact("Петров", "567-61-63");
